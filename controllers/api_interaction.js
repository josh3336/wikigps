...
var api_interaction = module.exports = {};

api_interaction.get_wiki = function(req,res){
  var body = '';
...
api_interaction.get_local_wikis = function(req,res){
	var body = '';
  console.log('handling POST',req.url);
  req.on('data',function(chunk){
    console.log('chunk',chunk);
...
api_interaction.get_sound = function(req,res){
  var body='';
  var chunkrec;
  req.on('data',function(chunk){
